...
export const ImportWorkspace = () => {
  ...
  return (
    <PageWrapper
      title="Import Workspaces"
      subTitle="Easily transfer workspaces from Terraform Cloud and Terraform Enterprise to Terrakube."
      breadcrumbs={[
    ...
    >
      ...
      <Content hidden={stepsHidden}>
        ...
        >
          <Space hidden={step3Hidden} className="chooseType" orientation="vertical">
            ...
            <div className="workflowDescription2 App-text">
              Provide the API token to connect with Terraform Cloud API. Terrakube will use this token exclusively for
              the duration of the migration process and will not store it. For guidance on generating an API token,
              refer to the{" "}
        ...
        <Space orientation="vertical" style={{ width: "100%" }} size="large">
          ...
          >
            <Typography.Text type="secondary">
              ...
              variables shown below can be filled now, left blank to stay incomplete, or discarded.
            </Typography.Text>
          </Card>
      ...
      <Space hidden={listHidden} orientation="vertical">
        ...
        <div className="workflowDescription2 App-text">
          Import of the selected workspaces is underway. You can monitor the progress for each workspace in the section
          below.
        </div>
        <List
