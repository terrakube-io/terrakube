...
@ReadPermission(expression = "team view policy_set")
@CreatePermission(expression = "team manage policy_set")
@UpdatePermission(expression = "team manage policy_set")
@DeletePermission(expression = "team manage policy_set")
