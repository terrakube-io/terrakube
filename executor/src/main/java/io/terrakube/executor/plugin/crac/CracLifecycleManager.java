package io.terrakube.executor.plugin.crac;
...
public class CracLifecycleManager implements Resource {
    ...
    public void registerCracResource() {
        log.info("Registering CRaC resource hook for Terrakube Executor");
        Core.getGlobalContext().register(this);
    }

    @Override
    public void beforeCheckpoint(Context<? extends Resource> context) throws Exception {
        log.info("CRaC beforeCheckpoint triggered: Preparing Terrakube Executor state for checkpointing...");
    }

    @Override
    public void afterRestore(Context<? extends Resource> context) throws Exception {
        long restoreStartTime = System.currentTimeMillis();
        log.info("CRaC afterRestore triggered: Re-initializing Terrakube Executor state at {}", Instant.now());
        ...
        log.info("Terrakube Executor CRaC post-restore initialization completed in {} ms", (System.currentTimeMillis() - restoreStartTime));
    }
}
