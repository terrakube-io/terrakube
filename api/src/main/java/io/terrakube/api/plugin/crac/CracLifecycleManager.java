package io.terrakube.api.plugin.crac;
...
public class CracLifecycleManager implements Resource {
    ...
    public void registerCracResource() {
        log.info("Registering CRaC resource hook for Terrakube API");
        Core.getGlobalContext().register(this);
    }

    @Override
    public void beforeCheckpoint(Context<? extends Resource> context) throws Exception {
        log.info("CRaC beforeCheckpoint triggered: Preparing Terrakube API state for checkpointing...");
    }

    @Override
    public void afterRestore(Context<? extends Resource> context) throws Exception {
        long restoreStartTime = System.currentTimeMillis();
        log.info("CRaC afterRestore triggered: Re-initializing Terrakube API state at {}", Instant.now());
        ...
        log.info("Terrakube API CRaC post-restore initialization completed in {} ms", (System.currentTimeMillis() - restoreStartTime));
    }
}
